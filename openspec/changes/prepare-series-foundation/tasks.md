...
- [ ] 7.2 If installation is explicitly authorized, sync only the `EveryQuest*` addon directories and prove repository/client parity separately from live gameplay; do not modify SavedVariables.
