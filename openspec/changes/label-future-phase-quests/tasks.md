...
- [x] 5.2 In the human-operated client, enable script errors, `/reload`, inspect representative short and long Phase 4/5 rows plus status-bearing rows, and verify marker/title/status order, clipping, colors, sorting, tooltip, links, and clicks; keep this task unchecked until the live path succeeds.
